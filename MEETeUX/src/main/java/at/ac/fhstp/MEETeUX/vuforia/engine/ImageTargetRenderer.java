...
package at.ac.fhstp.MEETeUX.vuforia.engine;
...
import at.ac.fhstp.MEETeUX.vuforia.SampleAppRenderer;
import at.ac.fhstp.MEETeUX.vuforia.SampleAppRendererControl;
import at.ac.fhstp.MEETeUX.vuforia.SampleApplicationSession;
import at.ac.fhstp.MEETeUX.vuforia.utils.CubeShaders;
import at.ac.fhstp.MEETeUX.vuforia.utils.LoadingDialogHandler;
import at.ac.fhstp.MEETeUX.vuforia.utils.MeshObject;
import at.ac.fhstp.MEETeUX.vuforia.utils.SampleApplication3DModel;
import at.ac.fhstp.MEETeUX.vuforia.utils.SampleMath;
import at.ac.fhstp.MEETeUX.vuforia.utils.SampleUtils;
import at.ac.fhstp.MEETeUX.vuforia.utils.Teapot;
import at.ac.fhstp.MEETeUX.vuforia.utils.Texture;
...
public class ImageTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    private Teapot sunthaym1;
    private Teapot sunthaym2;
    private Teapot accounting;
    private Teapot shrine;
    ...
    private void initRendering()
    {
        ...
        if(!mModelIsLoaded) {
            sunthaym1 = new Teapot(165,135);
            sunthaym2 = new Teapot(167,107);
            accounting = new Teapot(170,228);
            shrine = new Teapot(165,135);
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (TrackableResult result : trackableResultList)
        {
            ...
            if (result.isOfType(ImageTargetResult.getClassType()))
            {
                ...
                textureIndex = trackable.getName().equalsIgnoreCase("Sunthaym1") ? 0
                    : 0;
                textureIndex = trackable.getName().equalsIgnoreCase("Sunthaym2") ? 1
                        : textureIndex;
                textureIndex = trackable.getName().equalsIgnoreCase("Shrine") ? 2
                        : textureIndex;
