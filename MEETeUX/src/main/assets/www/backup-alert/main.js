...
/*!******************************************!*\
  !*** ./src/app/actions/StatusActions.ts ***!
  \******************************************/
/*! exports provided: CHANGE_ERROR_MESSAGE, StatusActions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var AppComponent = /** @class */ (function () {
    function AppComponent(appStore, userActions, locationActions, utilitiesService, winRef, nativeCommunicationService, dialog, alertService) {
        var _this = this;
...
var ContentTableOnComponent = /** @class */ (function () {
    ...
    ContentTableOnComponent.prototype.ngOnInit = function () {
        ...
        this.locationName = this._location.description;
        console.log("My parent location " + this._location.parentId);
...
var ExhibitService = /** @class */ (function () {
    ...
    ExhibitService.prototype.connectOD = function () {
        ...
        console.log("ConnectOD with my socket connection " + this.socket.connection);
    ...
    ExhibitService.prototype.startAutoResponder = function () {
        var _this = this;
        console.log("startAutoResponder with my socket connection " + this.socket.connection);
    ...
    ExhibitService.prototype.disconnect = function () {
        ...
        var state = this.appStore.getState();
        var user = state.user;
        console.log("mySocketConnection " + this.socket.connection);
